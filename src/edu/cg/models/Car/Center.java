...
public class Center implements IRenderable, IIntersectable {
	...
	public void render(GL2 gl) {
		...
		gl.glTranslated(0.0, Specification.C_BASE_HEIGHT,
				Specification.C_SIDE_LENGTH / 2.0 + Specification.C_FRONT_DEPTH_1 / 2.0);
	...
	public List<BoundingSphere> getBoundingSpheres() {
		...
		center_P = new Point(0.0, Specification.C_HIEGHT / 2.0, 0.0);
		radius_V = new Vec(Specification.C_LENGTH / 2,
				Specification.C_HIEGHT / 2,
				Specification.C_DEPTH / 2).norm();
		b_sphere = new BoundingSphere(radius_V, center_P);
		b_sphere.setSphereColore3d (0,1,0);
		res.add(b_sphere);
